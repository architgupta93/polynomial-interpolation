function outs = feature_example_cheb_series(function_handle)
% function outs = feature_example_cheb_series(function_handle)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Use of a truncated Chebyshev series for function approximation
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    disp('Example illustrating the use of Chebyshev Series exapansion.');
    ...
    disp('Instantiating Chebyshev Series.')
    cheb_series_interpolant = ChebSeries(function_handle, args{:});
    ...
    for t = 1 : length(t_pts)
        interpolated_values(t) = cheb_series_interpolant.computeWithDer(t_pts(t));
    end
