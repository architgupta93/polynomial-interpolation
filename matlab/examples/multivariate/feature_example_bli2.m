function outs = feature_example_bli2(function_handle)
% function outs = feature_example_bli2(function_handle)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Use of Barycentric Lagrange Interpolant for multi-variate function
% approximation
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    bl_interpolant = BLI2(function_handle, args{:});
