function outs = feature_example_Lagrange(function_handle)
% function outs = feature_example_Lagrange(function_handle)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Use of Lagrange Interpolant for function approximation
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    lag_interpolant = Lagrange(function_handle, args{:});
    ...
    for t = 1 : length(t_pts)
        interpolated_values(t) = lag_interpolant.computeWithDer(t_pts(t));
    end
