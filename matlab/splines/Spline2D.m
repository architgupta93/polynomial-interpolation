 classdef Spline2D < SplineInterpolant
    methods (Access = public)
        ...
        function [val, der] = computeWithDer(Obj, x_in, ~)
            ...
            pj_vals  = shiftdim([djl_3, djl_2, djl_1, 1], 1-ext_dims);
            ...
            val =   sum(cubicCoeffs3, 1+ext_dims)*dil_3 + ...
                    sum(cubicCoeffs2, 1+ext_dims)*dil_2 + ...
                    sum(cubicCoeffs1, 1+ext_dims)*dil_1 + ...
                    sum(cubicCoeffs0, 1+ext_dims);
